...
<template>
    <div class="flex h-full w-full justify-center md:mt-8">
        <div class="flex h-full w-full flex-col justify-start rounded-lg bg-white shadow-lg lg:w-3/4">
            <div class="flex h-full w-full flex-col justify-start md:flex-row">
                <div class="w-full p-4 md:w-1/2">
                    <div>
                        <label class="text-gray-500">Name of the drink</label>
                        <input type="text" class="border-grey-light mb-4 block w-full rounded border p-3" name="drinkName"
                            v-model="name" placeholder="Name of the drink" />
                    </div>
                    <div>
                        <label class="text-gray-500">Description of the drink</label>
                        <input type="text" class="border-grey-light mb-4 block w-full rounded border p-3"
                            name="drinkDescription" v-model="description" placeholder="Description of the drink" />
                    </div>
                    <div>
                        <label class="text-gray-500">Producer</label>
                        <select class="border-grey-light mb-4 block w-full rounded border p-3" v-model="producerId">
                ...
                <label class="m-2 h-full rounded-xl p-2 outline outline-gray-400 md:w-1/2">
