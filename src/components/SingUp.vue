...
<template>
  <div
    class="fixed h-screen w-screen bg-transparent-black-50"
    @click="clickBackground"
  >
    <div class="bg-grey-lighter flex min-h-screen flex-col">
      <div
        class="container mx-auto flex max-w-sm flex-1 flex-col items-center justify-center px-2"
        v-on:click.stop
      >
        <div class="w-full rounded-3xl bg-slate-200 p-8 text-black shadow-md">
          <div class="flex w-full justify-between">
            <h1
              @click="isSignUp = true"
              class="rounded-t-3xl px-4 text-center text-3xl"
          ...
          <div
            class="rounded-b-3xl bg-amber-400 p-3"
            :class="isSignUp ? 'rounded-tr-3xl' : 'rounded-tl-3xl'"
          >
            <input
              v-show="isSignUp"
              type="text"
